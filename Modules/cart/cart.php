<?php
	...
	?>
             ...
             <div id="my-cart">
                    ...
                    <div class="cart-item row">
                        ...
                        <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo number_format($total_price,0,'','.').'đ' ?></b><a href="Modules/cart/del-cat.php?id=<?php echo $row['prd_id']; ?>">Xóa</a></div>    
                    </div>  
                    <?php 
                        }
                    ?>
  ...
  <?php } 
        ...
        ?>
        <div class="alert alert-danger mt-3" >Hiện k có sản phẩm nào </div>
        <?php
  } ?>
